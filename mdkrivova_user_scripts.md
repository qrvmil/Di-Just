...
1. Главная страницы открывается сразу при входе на сайт  
...
3. Авторизовавшись в системе, пользователь может также сортировать дайджесты по тегам  
...
6. Пользователь может удалить из ленты свои дайджесты нажатием кнопки "delete"  
...
5. Аналогично пользователь может сохранить в непосредственно в самом расширении картинку или часть текста  
